...
<div class="login-content col-md-offset-3 col-md-6 well well-lg">
  <form class="public-form login" name="loginForm" ng-submit="login.submit(loginForm)">
    <div class="row">
      ...
      <div class="col-md-9 form-group"
        ...
        <input type="email" id="login_username" name="email" required placeholder="email"
               class="form-control" ng-model="login.user.email">
      </div>
    </div>
